...
if(isset($_POST['submit']))
{
 ...
 if($adminid!='' && $password!='')
 {
   $query=mysql_query("select * from admin where adminid='".$adminid."' and pwd='".$password."'") or die(mysql_error());
...
<tr>
<td for="adminid">Admin Id:</td>
<td><input class="demoInputBox" type="text" id="adminid" name="adminid"></td>
</tr>
<tr>
